...
PRODUCT_COPY_FILES += \
    ...
    addon/etc/apns-conf.xml:system/etc/apns-conf.xml \
    addon/etc/enhanced_blade.conf:system/etc/enhanced.conf \
...
#GPS FIX
PRODUCT_COPY_FILES += \
    device/zte/blade/GPS-FIX/system/lib/libcommondefs.so:system/lib/libcommondefs.so \
    device/zte/blade/GPS-FIX/system/lib/libloc.so:system/lib/libloc.so \
    device/zte/blade/GPS-FIX/system/lib/libloc-rpc.so:system/lib/libloc-rpc.so \
    device/zte/blade/GPS-FIX/system/lib/hw/gps.blade.so:system/lib/hw/gps.blade.so \
